...
public class FAR005_AverageOfArray {
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("Average: %.2f%n" ,average(nums));
...
Pattern Learned:
Accumulator Pattern + Arithmetic Computation

Mistakes I Made:
None

New Java Methods Learned:
Creating and calling a helper method.

New Concepts Learned:
Using a floating-point accumulator avoids integer division.
Type casting is another way to obtain a decimal result.
