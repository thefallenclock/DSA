...
==========================================================
Problem ID : FAR019
Problem    : Replace Odd Numbers with Zero
...
public class FAR019_ReplaceOddNumbersWithZero {
...
The condition arr[i] % 2 != 0 identifies odd numbers. 
An array can be selectively modified based on a condition while keeping the traversal unchanged.
